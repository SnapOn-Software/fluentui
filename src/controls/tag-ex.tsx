...
export const TagEx: React.FunctionComponent<React.PropsWithChildren<iProps>> = (props) => {
    return isFunction(props.action)
        ? <InteractionTag shape={props.shape} size={props.size} appearance={props.appearance} disabled={props.disabled} value={props.value}>
        ...
        : <Tag shape={props.shape} size={props.size} appearance={props.appearance} disabled={props.disabled}
