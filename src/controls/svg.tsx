...
export const NetSuiteIcon = (props: IProps) => {
    const { color, size } = getProps(props);

    return <svg height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0.2 150 150">
        <rect width="120.6" height="115.7" fill={color} />
        <g transform="translate(-14.6 -15.8)">
